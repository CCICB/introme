A1_Hazeem=[[-1.58496, 1.52119, -1.23807, 0.08158, -0.04756, -0.04756],
...
A1_Hazeem_july=[[-1.58496, 1.08580, -1.22876, 0.02561, -0.04211, -0.06541],
...
A1_neuBG=[[-1.58500, 1.58500, -1.58500, -1.58500, -1.58500, 0.97300],
...
A1_winBG=[[-1.58500, 1.28700, -1.58500, -1.58500, -1.58500, 0.69700],
...
SC35=[[-0.88295, 0.09027, -0.05874, -1.58496, 0.09027, -0.41277, -0.05874, 0.22531],
...
SF2_ASF=[[-1.13966, 0.62168, -1.58497, 1.32362, -1.58496, -1.58496, 0.62167],
...
SF2_ASF_IgM_BRCA1=[[-1.58496, 0.14630, -0.97480, 0.73608, -1.19324, -0.75317, 0.42996],
...
SRp40=[[-0.13024, -1.58497, 1.27654, -0.32624, 0.96960, -0.13025, -1.58496],
...
SRp55=[[-0.66247, 0.11035, -0.66247, 0.11035, -1.58496, 0.61087],
...
def main():
    ...
    for new, old in [(SRSF1, SF2_ASF), (SRSF1_igM, SF2_ASF_IgM_BRCA1), (SRSF2, SC35), (SRSF5, SRp40), (SRSF6, SRp55)]:
        A = np.array(new)
        B = np.array(old)
    ...
    print("hnRBPs")
    for rbp in [A1_Hazeem, A1_Hazeem, A1_neuBG, A1_winBG]:
        print(np.array_str(np.transpose(x:=np.exp2(rbp)), precision=3))
        print(x.sum(0))
