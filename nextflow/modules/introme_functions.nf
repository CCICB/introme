process introme_functions {
    ...
    output:
        path "introme_annotate.ag_check.vcf.gz", emit: ag_check
        path "introme_annotate.ag_check.vcf.gz.tbi", emit: ag_check_tbi
        path "introme_annotate.ESE.vcf", emit: ese_score
    ...
    python3 ${ag_script_path} ${annotated_vcf} ${ref_genome} ${template_header_vcf}
    bgzip introme_annotate.ag_check.vcf
    tabix introme_annotate.ag_check.vcf.gz
    ...
    python3 ${ese_script_path} ${annotated_vcf} ./introme_annotate.ESE.vcf ${ref_genome}
    """
